...
namespace Disharp.WebSocket.Payloads.SpecificPayloadData
{
	public class IdentifyPayload
	{
		...
		[JsonProperty("properties")] public IdentifyPropertiesPayload Properties { get; set; }

		[JsonProperty("compress")] public bool Compress { get; set; }

		[JsonProperty("large_threshold")] public int LargeThreshold { get; set; }

		[JsonProperty("presence")] public PresenceBuilder Presence { get; set; }

		[JsonProperty("intents")] public int Intents { get; set; }
	}
